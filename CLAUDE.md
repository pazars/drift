...
### IMPORTANT: No Attribution Lines

**NEVER include any of the following in commits, PRs, or any messages:**
- Co-Authored-By lines
- Email addresses
- "Generated with" or "Generated by" footers
- Any attribution to AI assistants or tools
- Author signatures of any kind

Keep all commit messages, PR titles, and PR bodies clean and focused only on the technical content.
